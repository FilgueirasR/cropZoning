...
#' zoning <- sr_ccrop_zoning(temp_per_month = tmean_monthly, temp1 = 10 , temp2 = 20, temp3 = 30, temp4 = 40)
#'
#' }
#' @return Returns a stack with a monthly climate crop zoning
#' @export

sr_ccrop_zoning <- function(temp_per_month, temp1, temp2,  temp3, temp4){
