...
#'
#'
#' @description This function will download the tmax and tmin and will load a rasterstack according to the the region of interest (Region and sub_region).
#' @param variable variable to download. This function will download the minimum (tmin) or maximum (tmax) air temperature (Rasterstack).
